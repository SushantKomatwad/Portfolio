  ...
  return (
    <div className="experience">
      ...
      <div className="education-container">
            ...
            <div className="new_circle" style={{ boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.9)" }}>78.85 %</div>
        ...
        <div className="education">
            <div className="new_circle" style={{ boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.9)" }}>76.77 %</div>
        ...
        <div className="education">
            <div className="new_circle" style={{ boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.9)" }}>88.20%</div>
